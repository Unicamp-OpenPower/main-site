...
<img src="./how-to-recover-access-to-a-minicloud-instance-images/1-create-new-key.png" width="80%"/>

Then, shut off your inaccessible instance

<img src="./how-to-recover-access-to-a-minicloud-instance-images/2-shut-off-instance.png" width="18%"/>

Now, create a snapshot of it

<img src="./how-to-recover-access-to-a-minicloud-instance-images/3-create-snapshot.png" width="80%"/>

Using the snapshot as image, launch a new instance, and select the newly created key.

<img src="./how-to-recover-access-to-a-minicloud-instance-images/4-launch-instance.png" width="80%"/>

<img src="./how-to-recover-access-to-a-minicloud-instance-images/5-select-new-key-pair.png" width="8%"/>
